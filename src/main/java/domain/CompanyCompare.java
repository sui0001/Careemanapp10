...
public class CompanyCompare {
    ...
    // コンストラクタ
    public CompanyCompare(String user_id, int company_id, String company_name, String selection_application,
            String selection_status, String selection_date, String selection_flow, String link_hp, String link_review,
            String selection_task, String selection_motivation, String positive_points, String negative_points, String points_to_confirm,
            int company_detail_id, String management_status, String business_content, String job_description,
            String work_location, String remote_work, String working_hours, int standard_working_hours, int break_time,
            String break_time_rule, int average_overtime_hours, int annual_holidays, String holiday_type, String paid_holidays,
            String other_holidays, String holiday_notes, int annual_salary_upper, int annual_salary_lower, int monthly_salary_upper,
            int monthly_salary_lower, int basic_salary_upper, int basic_salary_lower, int fixed_overtime_pay_upper, int fixed_overtime_pay_lower,
            int fixed_overtime_hours, String commuting_allowance, String housing_allowance, String qualification_support,
            String qualification_allowance, String other_allowances, String bonus, String bonus_record, String social_insurance,
            String probation_period, String probation_period_changes, String retirement_benefits) {
    ...
    public CompanyCompare(int company_id, String company_name, String selection_application,
            String selection_status, String selection_date, String selection_flow, String link_hp, String link_review,
            String selection_task, String selection_motivation, String positive_points, String negative_points, String points_to_confirm,
            int company_detail_id, String management_status, String business_content, String job_description,
            String work_location, String remote_work, String working_hours, int standard_working_hours, int break_time,
